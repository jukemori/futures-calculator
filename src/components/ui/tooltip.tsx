  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          'z-50 w-fit max-w-[16rem] origin-(--radix-tooltip-content-transform-origin) rounded-md border bg-popover px-3 py-2 text-xs leading-relaxed text-popover-foreground shadow-md',
